...
const report_actions_1 = require("./report.actions");
...
exports.ReportModule = ReportModule = __decorate([
    (0, common_1.Module)({
        imports: [inbound_module_1.InboundModule, outbound_module_1.OutboundModule],
        providers: [report_service_1.ReportService, report_actions_1.ReportActions],
