/**
 * Pure import helpers shared between the API (sync parity path) and the worker
 * (async auto-import). Mirror api/handlers/import_helpers.php.
 */
...
export function inferUom(upp: number): string {
